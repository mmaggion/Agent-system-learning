...
\end{equation}
in weak sense, 
where $\Fun{a}(z) =-a(|z|)z=-A'(|z|)z/|z|$, for $z \in \mathbb R^{d}$. In fact the differential equation \eqref{eq:meanfield} corresponds again to a gradient flow of the ``energy''
$$
